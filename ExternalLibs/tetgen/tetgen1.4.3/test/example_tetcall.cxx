...
int main(int argc, char *argv[])
{
  ...
  ////tetrahedralize("pq1.414a0.05", &in, &out);
  //tetrahedralize("pa0.1", &in, &out);
  //
  ...
  //out.save_faces("barout");
	...
	//in.load_node("barout");
	in.load_tetmesh("barout");

	//tetrahedralize("pq1.414a0.05", &in, &out);
	tetrahedralize("Va0.1q1.1r", &in, &out);


	// Output mesh to files 'barout.node', 'barout.ele' and 'barout.face'.
	out.save_nodes("barout2");
	out.save_elements("barout2");
	out.save_faces("barout2");
